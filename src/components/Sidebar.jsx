...
function Index() {
    ...
    return (
        <div className="flex flex-no-wrap">
            ...
            {/* Mobile sidebar */}
            <div className={`w-64 z-40 absolute top-96 bg-gray-800 shadow flex-col justify-between transition duration-150 ease-in-out md:hidden ${open ? 'bg-gray-600 translate-x-0' : 'bg-red-500-600 -translate-x-64'}`} >
            ...
            <div className="container mx-auto py-10 h-64 md:w-4/5 w-11/12 px-6">
                <div className="w-full h-full rounded border-dashed border-2 border-gray-300">Your content</div>
            </div>
